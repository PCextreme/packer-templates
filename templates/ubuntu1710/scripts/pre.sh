...
cd /tmp
wget http://nl.archive.ubuntu.com/ubuntu/pool/main/c/cloud-init/cloud-init_17.1-27-geb292c18-0ubuntu1~17.10.1_all.deb
dpkg -i cloud-init_17.1-27-geb292c18-0ubuntu1~17.10.1_all.deb
